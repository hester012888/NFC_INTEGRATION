...
export interface Exhibit {
  ...
  dynasty: string
  category: string
  imageUrl: string;   // ← 把 imageId 改成 imageUrl
  // imageId: string
  stampColor: string
  stampSymbol: string
  challenge: string
...
export const EXHIBITS: Exhibit[] = [
  {
    ...
    dynasty: "金·大定",
    category: "铜器",
    // imageId: "photo-1608037521277-154cd1b89191",
    imageUrl: imgE01,
    stampColor: "#7a8f6a",
    stampSymbol: "龙",
  ...
  },
  {
    ...
    dynasty: "金·大定",
    category: "丝织品",
    // imageId: "photo-1586190848861-99aa4a171e90",
    imageUrl: imgE02,
    stampColor: "#a8506a",
    stampSymbol: "织",
    challenge:
  ...
  },
  {
    ...
    dynasty: "唐·渤海国",
    category: "印章",
    // imageId: "photo-1545126131-11e5df3fbcb3",
    imageUrl: imgE04,
    stampColor: "#8b5a3a",
    stampSymbol: "印",
  ...
  },
  {
    ...
    dynasty: "更新世",
    category: "化石",
    // imageId: "photo-1565193566173-7a0ee3dbe261",
    imageUrl: imgE05,
    stampColor: "#7a6a8a",
    stampSymbol: "犀",
